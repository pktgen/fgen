...
#ifndef _FGEN_ETHER_H_
#define _FGEN_ETHER_H_
...
#define FGEN_ETHER_MAX_VLAN_FRAME_LEN (ETHER_MAX_LEN + 4)
/**< Maximum VLAN frame length, including CRC. */

#define FGEN_ETHER_MAX_JUMBO_FRAME_LEN 0x3F00 /**< Maximum Jumbo frame length, including CRC. */

#define FGEN_ETHER_MAX_VLAN_ID 4095 /**< Maximum VLAN ID. */

#define FGEN_ETHER_MIN_MTU 68 /**< Minimum MTU for IPv4 packets, see RFC 791. */
 ...
 */
struct fgen_vlan_hdr {
    uint16_t vlan_tci;  /**< Priority (3) + CFI (1) + Identifier Code (12) */
    uint16_t eth_proto; /**< Ethernet type of encapsulated frame. */
} __fgen_packed;

/* Ethernet frame types */
#define FGEN_ETHER_TYPE_IPV4            0x0800 /**< IPv4 Protocol. */
#define FGEN_ETHER_TYPE_IPV6            0x86DD /**< IPv6 Protocol. */
#define FGEN_ETHER_TYPE_ARP             0x0806 /**< Arp Protocol. */
#define FGEN_ETHER_TYPE_RARP            0x8035 /**< Reverse Arp Protocol. */
#define FGEN_ETHER_TYPE_VLAN            0x8100 /**< IEEE 802.1Q VLAN tagging. */
#define FGEN_ETHER_TYPE_QINQ            0x88A8 /**< IEEE 802.1ad QinQ tagging. */
#define FGEN_ETHER_TYPE_PPPOE_DISCOVERY 0x8863 /**< PPPoE Discovery Stage. */
#define FGEN_ETHER_TYPE_PPPOE_SESSION   0x8864 /**< PPPoE Session Stage. */
#define FGEN_ETHER_TYPE_ETAG            0x893F /**< IEEE 802.1BR E-Tag. */
#define FGEN_ETHER_TYPE_1588            0x88F7
/**< IEEE 802.1AS 1588 Precise Time Protocol. */
#define FGEN_ETHER_TYPE_SLOW  0x8809 /**< Slow protocols (LACP and Marker). */
#define FGEN_ETHER_TYPE_TEB   0x6558 /**< Transparent Ethernet Bridging. */
#define FGEN_ETHER_TYPE_LLDP  0x88CC /**< LLDP Protocol. */
#define FGEN_ETHER_TYPE_MPLS  0x8847 /**< MPLS ethertype. */
#define FGEN_ETHER_TYPE_MPLSM 0x8848 /**< MPLS multicast ethertype. */
 ...
 *  False (0) otherwise.
 */
FGEN_API __fgen_always_inline int
 ...
 */
FGEN_API __fgen_always_inline void
...
#define FGEN_ETHER_ADDR_FMT_SIZE 18
/**
...
FGEN_API __fgen_always_inline int8_t
...
FGEN_API __fgen_always_inline bool
 ...
 */
FGEN_API __fgen_always_inline struct ether_addr *
fgen_ether_aton(const char *a, struct ether_addr *e)
{
    int i;
    char *end;
...
FGEN_API __fgen_always_inline char *
