...
/**
 * @file
 * FGEN allocator for huge pages
 *
 * Allocate memory using MMAP anonymous memory using hugepages.
 */
 ...
 */
FGEN_API mmap_t *mmap_alloc(uint32_t bufcnt, uint32_t bufsz, mmap_type_t hugepage);
 ...
 */
FGEN_API int mmap_free(mmap_t *mmap);
 ...
 */
FGEN_API void *mmap_addr_at_offset(mmap_t *mm, size_t offset);
 ...
 */
FGEN_API void *mmap_addr(mmap_t *mm);
 ...
 */
FGEN_API size_t mmap_size(mmap_t *mm, uint32_t *bufcnt, uint32_t *bufsz);
 ...
 */
FGEN_API mmap_type_t mmap_type_by_name(const char *htype);
 ...
 */
FGEN_API const char *mmap_name_by_type(mmap_type_t typ);
 ...
 */
FGEN_API void mmap_set_default(mmap_type_t htype);
 ...
 */
FGEN_API void mmap_set_default_by_name(const char *name);
