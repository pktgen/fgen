 ...
 */
#define FGEN_ETH_SPEED_NUM_NONE    0          /**< Not defined */
#define FGEN_ETH_SPEED_NUM_10M     10         /**<  10 Mbps */
#define FGEN_ETH_SPEED_NUM_100M    100        /**< 100 Mbps */
#define FGEN_ETH_SPEED_NUM_1G      1000       /**<   1 Gbps */
#define FGEN_ETH_SPEED_NUM_2_5G    2500       /**< 2.5 Gbps */
#define FGEN_ETH_SPEED_NUM_5G      5000       /**<   5 Gbps */
#define FGEN_ETH_SPEED_NUM_10G     10000      /**<  10 Gbps */
#define FGEN_ETH_SPEED_NUM_20G     20000      /**<  20 Gbps */
#define FGEN_ETH_SPEED_NUM_25G     25000      /**<  25 Gbps */
#define FGEN_ETH_SPEED_NUM_40G     40000      /**<  40 Gbps */
#define FGEN_ETH_SPEED_NUM_50G     50000      /**<  50 Gbps */
#define FGEN_ETH_SPEED_NUM_56G     56000      /**<  56 Gbps */
#define FGEN_ETH_SPEED_NUM_100G    100000     /**< 100 Gbps */
#define FGEN_ETH_SPEED_NUM_200G    200000     /**< 200 Gbps */
#define FGEN_ETH_SPEED_NUM_400G    400000     /**< 400 Gbps */
#define FGEN_ETH_SPEED_NUM_UNKNOWN UINT32_MAX /**< Unknown */
 ...
 */
FGEN_API int netdev_change_flags(const char *if_name, uint32_t flags, uint32_t mask);
 ...
 */
FGEN_API int netdev_promiscuous_enable(const char *if_name);
 ...
 *   0 success or -1 on error
 */
FGEN_API int netdev_promiscuous_disable(const char *if_name);
 ...
 *   - (-1) on error
 */
FGEN_API int netdev_promiscuous_get(const char *if_name);
 ...
 *   0 success or -1 on error
 */
FGEN_API int netdev_set_link_up(const char *if_name);
 ...
 *   0 success or -1 on error
 */
FGEN_API int netdev_set_link_down(const char *if_name);
 ...
 */
FGEN_API int netdev_get_mac_addr(const char *ifname, struct ether_addr *eth_addr);
 ...
 *    -1 on error or o on success
 */
FGEN_API int netdev_get_link(const char *ifname, struct netdev_link *link);
 ...
 *    -1 on error or o on success
 */
FGEN_API int netdev_get_offloads(const char *ifname, struct offloads *off);
 ...
 */
FGEN_API int netdev_get_channels(const char *ifname);
 ...
 */
FGEN_API int netdev_set_channels(const char *ifname, uint32_t count);
 ...
 */
FGEN_API int netdev_get_ring_params(const char *ifname, uint32_t *rx_nb_desc, uint32_t *tx_nb_desc);
