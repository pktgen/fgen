...
#include "fgen_tty.h"        // for fgen_osal

static fgen_tty_t __fgen_tty;
fgen_tty_t *this_tty = &__fgen_tty;
...
FGEN_INIT_PRIO(__create, INIT)
{
    memset(this_tty, 0, sizeof(fgen_tty_t));
...
FGEN_FINI_PRIO(__destroy, INIT) { tty_destroy(); }
