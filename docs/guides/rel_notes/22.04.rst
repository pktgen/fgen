...
FGEN First Public Release 22.04
===============================

New Features
------------
* **Update CNI to do ethtool filter programming**
* **Add --no-color option to fgenfwd to remove color text**
* **Moved K8s device plugin to separate repo**
* **Added alternative to docker with CRI-O and Podman support**
* **Added support to allow FGEN to be built on Alpine Linux containers**
...
* **Add first draft of FGEN go-binding routines**
...
* The cnet-quic example application use quicly (https://github.com/h2o/quicly.git) library to
  demonstrate a simple QUIC application using the FGENT stack.
