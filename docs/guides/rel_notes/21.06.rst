...
* **Add support for unprivileged containers through FGEN device plugin**
* **Refactor Unix Domain Socket (UDS) Library to support REST API**
* **Add REST API to fgenfwd example with accompanying Go web-server frontend**
...
--------------------
* Replace xdpfwd and pktfwd examples with fgenfwd example
