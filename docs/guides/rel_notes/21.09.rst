...
* **Added CPU and interface scanning in the pod to generate FGEN configuration on the fly**
* **Added FGEN Device Plugin and CNI**
* **Added Unprivileged FGEN Pod support**

Some notable changes
--------------------
* The FGEN pod no longer needs privilege to create and use AF_XDP sockets.
